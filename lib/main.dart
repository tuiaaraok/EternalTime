...
void main() async {
  ...
  await Hive.openBox("menu_page_watch");
  Hive.registerAdapter(WatchModelAdapter());
  await Hive.openBox<WatchModel>(HiveBoxes.watchBox);
  ...
  Widget build(BuildContext context) {
    return ScreenUtilInit(
      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          scaffoldBackgroundColor: Color(0xFFE6E1F3),
...
Future<String> _initializeRemoteConfig() async {
  ...
  return link == ""
      ? "https://telegra.ph/EternalTime-Luxury-Tick---Privacy-Policy-02-19?showAgreebutton"
      : link;
}
